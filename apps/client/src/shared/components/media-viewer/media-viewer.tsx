...
import { ArrowDownToLineIcon, DownloadIcon, XCircleIcon, XIcon } from "lucide-react";
                  ...
                  switch (true) {
                     case attachment.type.includes("image"):
                        ...
                        mediaMeta.component = (
                           <img //
                              src={attachment.src}
                              className="block h-full mx-auto border w-full"
                           />
                        );
                        break;
                  ...
                  return {
                     ...
                     renderItem: () => (
                        <>
                           ...
                           <div className="h-[60vh] md:h-[80vh] flex items-center justify-center relative">{mediaMeta?.component}</div>
                        </>
                     ),
                  };
               })}
